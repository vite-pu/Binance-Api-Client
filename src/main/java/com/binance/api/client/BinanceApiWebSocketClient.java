...
public interface BinanceApiWebSocketClient extends Closeable {
    ...
    Closeable onDepthEvent5(String symbols, BinanceApiCallback<DepthEvent5> callback);
    ...
    Closeable onMarketTickersEvent(String symbols, BinanceApiCallback<MarketTickersEvent> callback);
    /**
